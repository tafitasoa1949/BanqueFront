    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Tany tany = foncierBean.getById(connexMysql, idTany);
                request.setAttribute("tany", tany);
                List<Detailtany> detailTany = foncierBean.getAllBornes(connexMysql, idTany);
                request.setAttribute("detailTany", detailTany);
                connexMysql.close();
                //
                RequestDispatcher dispatcher = request.getRequestDispatcher("showCarte.jsp");
